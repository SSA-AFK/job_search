...
| Current task | Stage one Task 2 - Create the Normalized Database Schema |
...
| Stage one progress | 1/8 tasks complete |
...
| Next action | Dispatch stage one Task 2 with the Task 1 application and database interfaces as context |
...
| 2 | Normalized database schema and migration | Ready | - | - | - |
