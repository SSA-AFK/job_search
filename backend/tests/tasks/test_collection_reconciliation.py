...
def test_checked_in_runtime_factory_composes_a_worker_without_operator_code() -> None:
    ...
    config = SimpleNamespace(
        ...
        ats_zhipin_enabled=False,
        ats_liepin_enabled=False,
        ats_lagou_enabled=False,
        ats_approved_hosts="jobs.feishu.cn,app.mokahr.com",
        zhipin_cdp_company_provider_enabled=False,
        zhipin_cdp_endpoint_url="http://127.0.0.1:9222",
        zhipin_cdp_min_match_score=80.0,
        zhipin_cdp_page_size=30,
        zhipin_cdp_max_pages=20,
        zhipin_cdp_block_threshold=2,
